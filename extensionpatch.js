        ...
        bot.commands.nomehCommand = {
            ...
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank,chat)) return void (0);
                    ...
                    API.sendchat("/me Hey there. We don't meh in this room!")
                }
            }
        };
        
        bot.commands.catfactsCommand = {
            command: 'catfacts',
            rank: 'user',
            type: 'exact',
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank,chat)) return void (0);
                    ...
                    API.sendchat("/me catfacts are still under construction!")
                }
            }
        };
